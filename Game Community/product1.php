...
<head>
    ...
    <title>PlayStation 5 White Edition</title>
    ...
    <div class="container">
        <div class="boxright">
            <div class="main-image-box">
                <img src="photo/play.jpg" id="bigimg" class="main-image">
            </div>
            <div class="small-images">
                <div class="image-box"> <img src="photo/play1.jpg" class="image"></div>
                <div class="image-box"> <img src="photo/play11.jpg" class="image"></div>
            </div>
        </div>
        <div class="details">
            ...
            <h2>$ 499.99</h2>
                ...
                <form   method="post">
                    <table class="inputs">
                <input type="hidden" name="product_name" value=" PS5 White Edition ">
