    ...
    <div class="container">
        <div class="boxright">
            <div class="main-image-box">
                <img src="photo/pc.jpg" id="bigimg" class="main-image">
            </div>
            <div class="small-images">
                <div class="image-box"> <img src="photo/pc1jpg.jpg" class="image"></div>
                <div class="image-box"> <img src="photo/pc2.jpg" class="image"></div>
            </div>
        </div>
        <div class="details">
            ...
            <form method="post">
                <table class="inputs">
                    <input type="hidden" name="product_name" value=" PC (Personal Computer ) ">
                    <tr>
                        <td>Quantity</td>
                ...
                <h4>Specification</h4>
                <p>Experience the next generation of gaming with the amaxing newly brand of PCs.</p>
                <h3>Recomended</h3>
                <div class="recomend">
