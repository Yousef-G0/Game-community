...
<head>
    ...
    <title>PlayStation 5 Black Edition</title>
    ...
    <div class="container">
        <div class="boxright">
            <div class="main-image-box">
                <img src="photo/playblack.jpg" id="bigimg" class="main-image">
            </div>
            <div class="small-images">
                <div class="image-box"> <img src="photo/playblack1.jpg" class="image"></div>
                <div class="image-box"> <img src="photo/playblack2jpg.jpg" class="image"></div>
            </div>
        </div>
        <div class="details">
            ...
            <form   method="post">
                    <table class="inputs">
                    <input type="hidden" name="product_name" value=" PlayStation 5 Black Edition ">
