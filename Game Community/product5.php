    ...
    <div class="container">
        <div class="boxright">
            <div class="main-image-box">
                <img src="photo/xbox11.jpg" id="bigimg" class="main-image">
            </div>
            <div class="small-images">
                <div class="image-box"> <img src="photo/xbox12.jpg" class="image"></div>
                <div class="image-box"> <img src="photo/xobox13.jpg" class="image"></div>
            </div>
        </div>
        <div class="details">
            ...
            <form method="post">
                <table class="inputs">
                    <input type="hidden" name="product_name" value=" xbox series x">
                    <tr>
                        <td>Quantity</td>
